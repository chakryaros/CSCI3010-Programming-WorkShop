...
int main() {
    ...
    std::cout << "Number of trees: " << steve.get_number_trees() << std::endl;

    // 3) Test to see whether pointers to your two Tree objects are equal.
    Tree *oak_pointer; Tree *steve_pointer;
    oak_pointer = &oak; steve_pointer = &steve;
    if(oak_pointer == steve_pointer){
