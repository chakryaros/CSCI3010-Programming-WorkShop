...
public:
    ...
    static Disease * GetCold(){
        ...
        Disease * d = new Disease("Cold", true, false, true, false, 0.8, 0.6, 0.3, 0.001, "new location");
        return d;
        
    }
        
    static Disease * GetChickenPox(){
        
        Disease * d = new Disease("Chicken Pox", true, false, false, true, 0.8, 0.1, 0.1, 0.0001, "new location");
        return d;
