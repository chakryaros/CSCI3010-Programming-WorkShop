...
#include "../lec17_mcdonald_ros/point.h"
...
QT_MOC_LITERAL(1, 6, 12), // "PointClicked"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 6), // "Point*"
QT_MOC_LITERAL(4, 27, 1), // "p"
QT_MOC_LITERAL(5, 29, 12), // "ShiftClicked"
QT_MOC_LITERAL(6, 42, 12) // "RightClicked"

    },
    "Point\0PointClicked\0\0Point*\0p\0ShiftClicked\0"
    "RightClicked"
};
...
void Point::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->PointClicked((*reinterpret_cast< Point*(*)>(_a[1]))); break;
        case 1: _t->ShiftClicked((*reinterpret_cast< Point*(*)>(_a[1]))); break;
        case 2: _t->RightClicked((*reinterpret_cast< Point*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Point::PointClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Point::*)(Point * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Point::ShiftClicked)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Point::*)(Point * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Point::RightClicked)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Point::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Point.data,
...
// SIGNAL 0
void Point::PointClicked(Point * _t1)
{
...
// SIGNAL 1
void Point::ShiftClicked(Point * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void Point::RightClicked(Point * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
